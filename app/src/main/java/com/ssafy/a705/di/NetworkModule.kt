package com.ssafy.a705.di

import android.content.Context
import com.ssafy.a705.network.AuthInterceptor
import com.ssafy.a705.network.GroupApiService
import com.ssafy.a705.network.LiveLocationStatusApi
import com.ssafy.a705.network.mypage.MypageApi
import com.ssafy.a705.network.sign.SignApi
import com.ssafy.a705.network.with.WithApi
...
import com.ssafy.a705.group.latecheck.LateFeeStorage
import com.ssafy.a705.group.latecheck.LiveLocationWebSocketClient
import com.ssafy.a705.group.latecheck.LiveLocationRepository
...
object NetworkModule {
    ...
    @Provides @Singleton
    fun provideChatApi(retrofit: Retrofit): com.ssafy.a705.chatSet.api.ChatApi =
        retrofit.create(com.ssafy.a705.chatSet.api.ChatApi::class.java)

    // 그룹 채팅 API 추가
    @Provides @Singleton
    fun provideGroupChatApi(retrofit: Retrofit): com.ssafy.a705.group.chat.GroupChatApi =
        retrofit.create(com.ssafy.a705.group.chat.GroupChatApi::class.java)
    ...
    fun provideGroupChatWebSocketClient(
        okHttpClient: OkHttpClient
    ): com.ssafy.a705.group.chat.GroupChatWebSocketClient {
        return com.ssafy.a705.group.chat.GroupChatWebSocketClient(okHttpClient)
    }
    ...
    fun provideGroupChatRepository(
        groupChatApi: com.ssafy.a705.group.chat.GroupChatApi,
        webSocketClient: com.ssafy.a705.group.chat.GroupChatWebSocketClient
    ): com.ssafy.a705.group.chat.GroupChatRepository =
        com.ssafy.a705.group.chat.GroupChatRepository(groupChatApi, webSocketClient)
}
